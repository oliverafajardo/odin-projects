...
i learned that in html, that when a class is seperated by a space, it means two classes
if you only want one class, you use a dash for example, class='avatar-proportioned' instead of class='avatar proportioned'
